...
HD_PWD='C:/Users/uceas/NeoRV32_wrx/NeoRV32_wrx.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log neorv32_ProcessorTop_Test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source neorv32_ProcessorTop_Test.tcl -notrace
