...
HD_PWD='C:/Users/uceas/NeoRV32_wrx/NeoRV32_wrx.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log neorv32_ProcessorTop_Test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neorv32_ProcessorTop_Test.tcl
